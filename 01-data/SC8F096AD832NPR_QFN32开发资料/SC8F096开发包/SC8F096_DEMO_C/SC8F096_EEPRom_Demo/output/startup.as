	...
	; Compiler options:
	;
	; -oSC8F096_EEPROM_C.cof -mSC8F096_EEPROM_C.map \
	; --summary=default,-psect,-class --fill=0xFFFF --output=intel \
	; SC8F096_EEPROM_C.p1 --chip=SC8F096 -P --runtime=default, \
	; --opt=-local,-asmfile,+asm,-speed,+space,-debug -E+cmscerr.err \
	; -D__DEBUG=1 -g --asmlist --warn=-8 --stack=compiled:auto:auto:auto \
