...
#include <sc.h>
#define	ENABLE_IIC
#pragma warning disable 373,752
//按键通道选择(1-16)	//定义要检测的按键，否则注释掉
#define		C_KEY_1		1
#define		C_KEY_2		1
#define		C_KEY_3		1
#define		C_KEY_4		1
...
#define			I2C_SCL			RC4
#define			I2C_SDA			RC5
volatile bit  	I2C_SCL_IO		@((unsigned)&TRISC*8)+4;		//IB口方向设置
volatile bit  	I2C_SDA_IO		@((unsigned)&TRISC*8)+5;		//IB口方向设置
...
#define		TP_EN			0X10
#define		TK_LDOEN		0X08
#define		TK_LDOSEL		0X00		//2.4V为0X04
#define		TK_EN			0X01

#define		C_KEYCON2		C_LVBO|TP_EN|TK_LDOEN|TK_LDOSEL|TK_EN
