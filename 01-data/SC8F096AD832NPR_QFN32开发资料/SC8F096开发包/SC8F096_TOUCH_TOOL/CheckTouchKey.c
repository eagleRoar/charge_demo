...
{	
	...
	#ifdef	C_KEY_8
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS8;		 //0.5VDD,FRES/4，通道1	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_9
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS9;		 //0.5VDD,FRES/4，通道2	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_10
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS10;		 //0.5VDD,FRES/4，通道3	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_11
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS11;		 //0.5VDD,FRES/4，通道4	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_12
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS12;		 //0.5VDD,FRES/4，通道5	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_13
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS13;		 //0.5VDD,FRES/4，通道6	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_14
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS14;		 //0.5VDD,FRES/4，通道7	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
	...
	#ifdef	C_KEY_15
	KEYCON0 = 0x02;      //使能电容口，不并联电容
	KEYCON1 = C_KCHS15;		 //0.5VDD,FRES/4，通道7	
	KEYCON2 = C_KEYCON2|0X01;
	asm("nop");
	asm("nop");
	asm("nop");
